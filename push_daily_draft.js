...
// Read all 3 article HTML files
const articles = [
  {
    title: '6亿人没有电的大陆，中国人带着太阳能板来了',
    file: 'article_solar_africa.html'
  },
  {
    title: '宁德时代花了73亿欧元在匈牙利建厂，然后被当地人告上了法�?,
    file: 'article_catl_hungary.html'
  },
  {
    title: '原神年入过百亿，但老外知道它是中国游戏�?,
    file: 'article_genshin_culture.html'
  }
];
...
async function main() {
  try {
    ...
    console.log('Adding draft with 3 articles...');
